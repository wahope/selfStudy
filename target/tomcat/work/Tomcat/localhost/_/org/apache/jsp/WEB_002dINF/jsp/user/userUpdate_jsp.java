 ...
 * Generated at: 2019-05-12 08:26:46 UTC
...
public final class userUpdate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<div class=\"layui-input-block\">\n");
      out.write("\t\t\t\t\t<input type=\"text\" class=\"layui-input userName\" disabled lay-verify=\"userName\" placeholder=\"请输入资料标题\">\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div class=\"layui-form-item magt3\">\n");
      out.write("\t\t\t\t<label class=\"layui-form-label\">密码</label>\n");
      out.write("\t\t\t\t<div class=\"layui-input-block\">\n");
      out.write("\t\t\t\t\t<input type=\"password\" class=\"layui-input password\" lay-verify=\"password\" placeholder=\"请输入资料标题\">\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div class=\"layui-form-item magt3\">\n");
      out.write("\t\t\t\t<label class=\"layui-form-label\">电话号码</label>\n");
      out.write("\t\t\t\t<div class=\"layui-input-block\">\n");
      out.write("\t\t\t\t\t<input type=\"tel\" class=\"layui-input mobile\" lay-verify=\"mobile\" placeholder=\"请输入资料标题\">\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div class=\"layui-form-item magt3\">\n");
      out.write("\t\t\t\t<label class=\"layui-form-label\">住址</label>\n");
      out.write("\t\t\t\t<div class=\"layui-input-block\">\n");
      out.write("\t\t\t\t\t<input type=\"text\" class=\"layui-input address\" lay-verify=\"address\" placeholder=\"请输入资料标题\">\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div class=\"layui-form-item magt3\">\n");
      out.write("\t\t\t\t<label class=\"layui-form-label\">注册时间</label>\n");
      out.write("\t\t\t\t<div class=\"layui-input-block\">\n");
      out.write("\t\t\t\t\t<input type=\"text\" disabled class=\"layui-input createTime\" lay-verify=\"createTime\" placeholder=\"请输入资料标题\">\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div class=\"layui-form-item magt3\">\n");
      ...
      out.write("\t\t\t<a class=\"layui-btn layui-btn-sm\" lay-filter=\"updateUser\" lay-submit><i class=\"layui-icon\">&#xe609;</i>修改</a>\n");
      out.write("\t\t</div>\n");
      out.write("\t</div>\n");
      out.write("\t</div>\n");
      out.write("\n");
      ...
      out.write("<script type=\"text/javascript\" src=\"/js/user/userList.js\"></script>\n");
      out.write("<script type=\"text/javascript\" src=\"/js/user/userUpdate.js\"></script>\n");
