	...
	<div class="layui-col-md9 layui-col-xs12">
		<div class="layui-row layui-col-space10">
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input panTitle" lay-verify="panTitle" placeholder="请输入资料标题">
					</div>
				</div>
				<div class="layui-form-item magt3">
					<label class="layui-form-label">下载地址</label>
					<div class="layui-input-block">
						<input type="url" class="layui-input panUrl" lay-verify="panUrl" placeholder="请输入资料下载地址">
					</div>
				</div>
				<div class="layui-form-item magt3">
		...
		<div class="layui-right">
			<a class="layui-btn layui-btn-sm" lay-filter="updatePan" lay-submit><i class="layui-icon">&#xe609;</i>修改</a>
		</div>
		</div>
	</div>
