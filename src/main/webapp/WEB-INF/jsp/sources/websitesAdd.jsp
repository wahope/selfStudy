...
<form class="layui-form layui-row layui-col-space10">
	<div class="layui-col-md9 layui-col-xs12">
		<div class="layui-row layui-col-space10">
			...
			<div class="layui-form-item magt3">
				...
				<div class="layui-input-block">
					<input type="text" class="layui-input websitesName" lay-verify="websitesName" required placeholder="请输入软件名称">
				</div>
			</div>
			<div class="layui-form-item magt3">
				<label class="layui-form-label">网站地址</label>
				<div class="layui-input-block">
					<input type="url" class="layui-input websitesUrl" lay-verify="websitesUrl" required placeholder="请输入软件下载地址">
				</div>
			</div>
			<div class="layui-form-item magt3">
		...
		<div class="layui-right">
			<a class="layui-btn layui-btn-sm" lay-filter="addWeb" lay-submit><i class="layui-icon">&#xe609;</i>添加</a>
		</div>
	</div>
	</div>
