...
<form class="layui-form layui-row layui-col-space10">
	<div class="layui-col-md9 layui-col-xs12">
		<div class="layui-row layui-col-space10">
				...
				<div class="layui-form-item magt3">
					<label class="layui-form-label" style="margin-right: 33px;">专业Id</label>
				...
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input title" lay-verify="title" placeholder="请输入资料标题">
					</div>
				</div>
		...
		<div class="layui-right">
			<a class="layui-btn layui-btn-sm" lay-filter="updateNews" lay-submit><i class="layui-icon">&#xe609;</i>修改</a>
		</div>
		</div>
	</div>
...
<script type="text/javascript" src="/js/news/newsUpdate.js"></script>
